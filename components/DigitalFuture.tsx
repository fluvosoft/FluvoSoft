  ...
  const challenges = [
    {
      ...
      text: 'Unsustainable operating costs',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const solutions = [
    {
      ...
      text: 'Scalable, distributed infrastructure',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      text: 'Smarter workflows and optimized business processes',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      text: 'Design, develop and manage new financial assets with us',
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start md:items-center">
            ...
            >
              <svg className="w-24 h-full" viewBox="0 0 100 300" preserveAspectRatio="xMidYMid meet">
                {/* Dotted line path - diamond/hourglass shape */}
                <motion.path
                ...
                />
                {/* Middle circle (larger with white center) */}
                <motion.circle
                  cx="50"
                  cy="150"
                  r="10"
