        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              className="bg-white rounded-lg border border-gray-200 shadow-md p-8"
            >
            ...
            <motion.div
              ...
              className="bg-white rounded-lg border border-gray-200 shadow-md p-8"
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal text-gray-900 mb-10">
                Contact Info
              </h2>
              ...
              <div className="space-y-6 mb-12">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-gray-700 mb-1 text-sm uppercase tracking-wide">Email</div>
                    <div className="text-black font-medium group-hover:text-brand-orange transition-colors">fluvosoftinfo@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-gray-700 mb-1 text-sm uppercase tracking-wide">Phone</div>
                    <div className="text-black font-medium group-hover:text-brand-orange transition-colors">01762746646</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-gray-700 mb-1 text-sm uppercase tracking-wide">Address</div>
              ...
              <div className="pt-8 border-t border-gray-200">
                <div className="font-semibold text-black mb-6 text-lg">Connect with us</div>
