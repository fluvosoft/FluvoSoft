        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Email */}
              <div className="bg-white/5 rounded-xl p-8 text-center hover:shadow-lg transition-shadow border border-white/20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-white/5 rounded-xl p-6 border border-white/20 hover:shadow-md transition-shadow"
                >
